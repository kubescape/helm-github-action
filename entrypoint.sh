...
COMMAND="helm template $INPUT_CHARTNAME $INPUT_CHARTPATH $INPUT_HELMARGS | kubescape scan $FRAMEWORK_CMD $CONTROL_CMD --fail-threshold $INPUT_THRESHOLD $INPUT_KUBESCAPEARGS -"
